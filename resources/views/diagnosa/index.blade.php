...
@section('body')
    ...
    <a class="btn btn-primary col-2 mb-xl-4" style="color:#ffff" href={{ route('index_kelompok') }}><i
            class="bi bi-person-add mr-2"></i> Tambah Kelompok</a>
    <a class="btn btn-success col-2 mb-xl-4" style="color:#ffff" href={{ route('diagnosa.create') }}><i
            class="bi bi-person-add mr-2"></i> Diagnosa</a>
